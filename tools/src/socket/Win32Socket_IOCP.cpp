...
//	void CSocketMgr::AddSocket(boost::shared_ptr<CWinSocket>  newsock)
//	{
...
//			return ;
//		}
//		CreateIoCompletionPort((HANDLE)newsock->m_sock,m_hIOCP,ULONG_PTR(newsock.get()),0);
//		newsock->pushReadEvent();
//		m_WinSocketList.insert(newsock);
//	}
//	void CSocketMgr::shutdown(boost::shared_ptr<CWinSocket>  sock)
//	{
...
//	}
//
//	void CSocketMgr::OnWrite(boost::shared_ptr<CWinSocket>  sock,int len)
//	{
//
//		if(sock==NULL||len==0){return ;}
//		sock->m_pWriteBlockMutex.acquire();
//		sock->m_writeBlock.skip_rd(len);
