...
typedef boost::function<void (PreparedQueryResult) > PreparedQueryCallBackFunc;
...
class PreparedStatementTask : public SQLOperation
{
    public:
        ...
        PreparedStatementTask(PreparedStatement* stmt, PreparedQueryCallBackFunc callback);
    ...
    protected:
        PreparedStatement* m_stmt;
        bool m_has_result;
        PreparedQueryCallBackFunc m_callback;
};
#endif
